...
<script type="text/javascript" src="js/textarea_maxlen.js"></script>
    ...
    <script src="js/ajaxjquery.1.7.js"></script> 
...
<div style="float:left; width:120px; height:400px; margin:250px 0 0 -220px; position:fixed;">
	<div class="boxbot1">
		<div class="box">A</div>
		<div class="box">D</div>
		<div class="box">E</div>
...
?>
<div class="st">
    <form action="aksi_updatestatus.php?at=update_mention" id="myForm" method="post" onSubmit="return validasi(this)">
